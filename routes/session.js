...
const { getAll, remove } = require("../controller/session");
 ...
 */
SessionRouter.get("/me", authMiddleware, getAll);

/**
 * @swagger
 * /session/delete:
 *   delete:
 *     summary: 🗑️ Delete current session
 *     description: ⚠️ Deletes the latest session for the authenticated user.
 *     tags: [🔐 Sessions]
 *     security:
 *       - BearerAuth: []
 *     responses:
 ...
 *         description: 🚨 Internal server error.
 */
SessionRouter.delete("/delete", authMiddleware, remove);
